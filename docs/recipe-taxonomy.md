...
| **Yi-1.5-9B-Chat v4** | dense | 9B | attention + dense FFN | 2 | 5090 | ❌ **−28.6pp**: catastrophic regression. rag_datasheet 55→29/78 (−26), multihop 6→0/9, coding 4→0/6, numerical_precision 6→3/6. The only category that gained is refusal (6→9/9, +3). GPT-4o cross-judge corroborates at Δ −0.714 (Sonnet pending). Falsifies "≥3/6 reasoning → lift" predictor. | ✅ | ✅ refusal 9/9 | **39.7%** |
